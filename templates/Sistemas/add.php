<?php
$this->layout = 'main';
$this->assign('title', 'Criar Sistema - MaisSolar');
...
<h1 class="text-4xl font-bold text-text-light-primary dark:text-text-dark-primary mb-8">Criar Novo Sistema</h1>
...
<nav class="flex mb-6" aria-label="Breadcrumb">
    <ol class="inline-flex items-center space-x-1 md:space-x-3">
        ...
        <li aria-current="page">
            <div class="flex items-center">
                <i class="fas fa-chevron-right text-text-light-secondary dark:text-text-dark-secondary mx-2"></i>
                <span class="text-sm font-medium text-text-light-primary dark:text-text-dark-primary">Criar Sistema</span>
            </div>
        </li>
    </ol>
</nav>
...
<div class="flex justify-end space-x-4 pt-6">
    ...
    <?= $this->Form->button('Criar Sistema', [
        'type' => 'submit',
...
$(document).ready(function() {
    ...
    <?php if (isset($success) && $success): ?>
        toastr.success('Sistema criado com sucesso!');
    <?php endif; ?>
    
    <?php if (isset($error) && $error): ?>
        toastr.error('Erro ao criar sistema. Verifique os dados e tente novamente.');
    <?php endif; ?>
});
</script>